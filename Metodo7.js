...
//Esse método é utilizado para retornar o índice do primeiro elemento em um array que satisfaz uma determinada condição promovida por uma função de retorno de chamada. Caso não corresponda a condição, dseu retorno será -1
